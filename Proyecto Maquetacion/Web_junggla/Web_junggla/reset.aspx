<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reset.aspx.cs" Inherits="Web_junggla.reset" %>
...
<div id="login" class="accounts-form">
  <h3>Introduce una dirección de correo electrónico para ayudarnos a encontrar tu cuenta de Junggla.</h3>
   ...
   <form action="/login" method="POST" id="auth-form">
    ...
    <div class="all-errors">
        ...
        <button type="button" class="close" data-dismiss="alert">×</button>
          Este correo no esta registrado, por favor intente con otro <br />
    ...
    <input type="submit" value="Enviar dirección" class="btn btn-green">
