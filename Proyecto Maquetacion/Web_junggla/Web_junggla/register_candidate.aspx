<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register_candidate.aspx.cs" Inherits="Web_junggla.register_candidate" %>
...
<div id="login" class="accounts-form">
  <h2>Ya puedes únirte a Junggla hoy mismo</h2>
   ...
   <form action="/login" method="POST" id="auth-form">
    ...
    <div class="all-errors">
        ...
        <button type="button" class="close" data-dismiss="alert">×</button>
          Este usuario ya esta registrado, por favor intente con otro <br />
          o solicite una invitación.
         </div>
          <div class="alert alert-error">
          <button type="button" class="close" data-dismiss="alert">×</button>
           Por favor debe rellenar todos los datos.
           </div>
          <div class="alert alert-error">
          <button type="button" class="close" data-dismiss="alert">×</button>
      ...
      <div class="input">
        <input id="id_name" type="text" name="name" maxlength="75" placeholder="Nombre">
        
      </div>
      <div class="input">
        <input id="id_fullname" type="text" name="fullname" maxlength="75" placeholder="Apellidos">
    ...
    <div class="input">
        <input type="password" name="verifypassword" id="id_verifypassword" placeholder="Verificar contraseña">
    </div>
    <div class="actions clearfix">
    <input type="submit" value="Únete" class="btn btn-green">
