...
<%@ Register TagPrefix="jgg" TagName="ctlNewPassword" Src="~/DesktopModules/Junggla.Login/Controls/ctlNewPassword.ascx" %>
    ...
    <div id="Content">
        <div id="Panes">
            <div id="ContentPane" runat="server">
				<jgg:ctlNewPassword id="ctlNewPassword" runat="server" />
			</div>
