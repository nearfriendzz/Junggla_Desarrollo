...
<%@ Register TagPrefix="jgg" TagName="ctlRecoverPassword" Src="~/DesktopModules/Junggla.Login/Controls/ctlRecoverPassword.ascx" %>
    ...
    <div id="Content">
        <div id="Panes">
            <div id="ContentPane" runat="server">
				<jgg:ctlRecoverPassword id="ctlRecoverPassword" runat="server" />
			</div>
