...
<div class="dnnForm dnnLanguagePackWriter dnnClear" id="dnnLanguagePackWriter">
    <fieldset>
        ...
        <div class="dnnFormItem">
            ...
            <asp:radiobuttonlist id="rbPackType" runat="server" AutoPostBack="true" Repeatdirection="Horizontal" CssClass="lpwRadioButtons" RepeatLayout="Flow">
        ...
        <div id="rowFileName" runat="server" class="dnnFormItem">
			...
			<asp:Label id="Label2" runat="server">ResourcePack.</asp:Label><asp:textbox id="txtFileName" runat="server">Core</asp:textbox>
